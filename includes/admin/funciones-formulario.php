<?php
	...
	$listado_de_proveedores = array(
		...
		"smsgatewaycenter" => "SMS Gateway Center",
	...
	$campos_de_proveedores = array(
		...
		"smsgatewaycenter" => array(
			"usuario_smsgatewaycenter" => __('username', 'woocommerce-apg-sms-notifications'),
			"contrasena_smsgatewaycenter" => __('password', 'woocommerce-apg-sms-notifications'),
			"identificador_smsgatewaycenter" => __('sender ID', 'woocommerce-apg-sms-notifications'),
		),
